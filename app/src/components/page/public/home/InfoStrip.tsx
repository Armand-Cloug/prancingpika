...
export default function InfoStrip() {
  return (
    <>
      ...
      <div className="rounded-xl border border-white/10 bg-[#2A3B4F]/70 px-4 py-3 text-sm text-zinc-200/90">
        <span className="font-medium text-zinc-100">Guild Info:</span>{" "}
        It’s possible to create your guild, but the feature that lets players join a guild isn’t working yet. 
        This means that for now, only one player per guild will be able to upload parses.
      </div>
